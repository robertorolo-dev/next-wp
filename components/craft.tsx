...
const styles = {
  typography: {
    ...
    tables: [
      ...
      "md:[&_td]:border-r md:[&_td]:border-primary/10 [&_td]:px-6 [&_td]:py-4 md:[&_td]:last:border-0 max-md:[&_td]:grid max-md:[&_td]:grid-cols-[140px_1fr] max-md:[&_td]:gap-x-4 max-md:[&_td]:items-center max-md:[&_td]:border-b max-md:[&_td]:border-primary/5 max-md:[&_td]:last:border-b-0 max-md:[&_td]:px-6 max-md:[&_td]:py-4 max-md:[&_td]:text-right max-md:[&_td]:before:content-[attr(data-label)] max-md:[&_td]:before:font-bold max-md:[&_td]:before:text-xs max-md:[&_td]:before:uppercase max-md:[&_td]:before:tracking-widest max-md:[&_td]:before:opacity-50 max-md:[&_td]:before:text-left",
    ],
    media: [
